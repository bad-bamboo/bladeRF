 ...
 * @return 0 on success, value from \ref RETCODES list on failure
 */
API_EXPORT int CALL_CONV bladerf_set_bandwidth(struct bladerf *dev, bladerf_module module,
 ...
 * @return 0 on success, value from \ref RETCODES list on failure
 */
API_EXPORT int CALL_CONV bladerf_get_bandwidth(struct bladerf *dev, bladerf_module module,
                                               unsigned int *bandwidth);
 ...
 * @return 0 on success, value from \ref RETCODES list on failure
 */
API_EXPORT int CALL_CONV bladerf_set_lpf_mode(struct bladerf *dev, bladerf_module module,
 ...
 * @return 0 on success, value from \ref RETCODES list on failure
 */
API_EXPORT int CALL_CONV bladerf_get_lpf_mode(struct bladerf *dev, bladerf_module module,
                                              bladerf_lpf_mode *mode);
 ...
 */
API_EXPORT int CALL_CONV bladerf_select_band(struct bladerf *dev, bladerf_module module,
 ...
 *          value from \ref RETCODES list on failure
 */
API_EXPORT int CALL_CONV bladerf_tx(struct bladerf *dev, bladerf_format format,
 ...
 */
API_EXPORT int CALL_CONV bladerf_rx(struct bladerf *dev, bladerf_format format,
                                    void *samples, int num_samples,
                                    struct bladerf_metadata *metadata);
 ...
 * @return 0 on success, value from \ref RETCODES list on failure
 */
API_EXPORT int CALL_CONV bladerf_stats(struct bladerf *dev, struct bladerf_stats *stats);
 ...
 * @return 0 on success, value from \ref RETCODES list on failure
 */
API_EXPORT int CALL_CONV bladerf_si5338_set_rx_freq(struct bladerf *dev,
                                                    unsigned freq);
 ...
 */
API_EXPORT void CALL_CONV bladerf_set_transfer_timeout(struct bladerf *dev, bladerf_module module, int timeout);
 ...
 */
API_EXPORT int CALL_CONV get_transfer_timeout(struct bladerf *dev, bladerf_module module);
 ...
 *         RETCODES list on failure
 */
API_EXPORT int CALL_CONV bladerf_read_flash_unaligned(struct bladerf *dev,
                                                      uint32_t addr,
                                                      uint8_t *pbuf,
                                                      uint32_t len);
 ...
 *         RETCODES list on failure
 */
API_EXPORT int CALL_CONV bladerf_program_flash_unaligned(struct bladerf *dev,
                                                         uint32_t addr,
                                                         uint8_t *buf,
                                                         uint32_t len);
